/* Luxury Way Store - Final Image Path Fix */

(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.JenniferLoaded)return;r.JenniferLoaded=!0;const i=n(r);fetch(r.href,i)}})();

// Yahan humne paths ko "./assets/filename" kar diya hai
const d=[
...
let a=[];
function c(){const e=document.getElementById("product-grid");if(e){e.innerHTML=d.map(t=>`
    <div class="product-card">
        <img src="${t.image}" alt="${t.name}" onerror="this.src='https://via.placeholder.com/300?text=Image+Not+Found'">
...
`).join("")}}
window.addToCart=function(e){const t=d.find(n=>n.id===e);a.push(t);l();alert(t.name+" added to cart!")};
function l(){const e=document.getElementById("cart-count");if(e){e.innerText=a.length}}
